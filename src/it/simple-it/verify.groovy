...
assert 'simple-it' == getXmlValue(configurationFile, '//service/id')
assert 'simple-it' == getXmlValue(configurationFile, '//service/name')
assert null == getXmlValue(configurationFile, '//service/description')
assert 'java' == getXmlValue(configurationFile, '//service/executable')
assert '-jar simple-it-1.0-SNAPSHOT.jar' == getXmlValue(configurationFile, '//service/arguments')
